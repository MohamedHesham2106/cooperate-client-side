...
const Hero: React.FC = () => {
  return (
    <div className='relative h-[90vh] mt-16 p-6 flex items-center overflow-hidden bg-gray-900'>
      <div className=' relative flex px-6 pt-12'>
        <div className='relative flex flex-col w-full'>
          <h1 className='flex flex-col text-3xl font-black leading-none text-white uppercase font-bebas-neue sm:text-5xl '>
          ...
          <div className='flex mt-8'>
            <Link
              href='/signup'
              className='text-xs font-semibold sm:text-base px-4 py-2 mr-4 text-white uppercase bg-blue-500 border-2 border-transparent rounded-full text-md hover:bg-blue-400'
            >
              Get Started
            </Link>
          </div>
